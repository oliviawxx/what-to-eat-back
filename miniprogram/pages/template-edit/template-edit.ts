Page({
  ...
  onGenderChange(e: WechatMiniprogram.PickerChange) {
    this.setData({ genderIndex: parseInt(e.detail.value as string, 10) })
  },
  onPeopleChange(e: WechatMiniprogram.PickerChange) {
    this.setData({ peopleIndex: parseInt(e.detail.value as string, 10) })
  },
  onTimeInput(e: WechatMiniprogram.Input) {
